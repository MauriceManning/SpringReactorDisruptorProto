        ...
        <div class="table-body">
            <table class="zebra" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th class="sort-field sort-field-licensed">Licensed</th>
                    ...
                    <th class="sort-field sort-field-timestamp numeric">Last Heart Beat</th>
                ...
                <c:if test="${empty agents}">
                    <tr>
                        <td colspan="3">no <c:out value="${fn:toLowerCase(pageTitle)}"/> connected</td>
                    </tr>
                </c:if>
            </table>
        </div>
