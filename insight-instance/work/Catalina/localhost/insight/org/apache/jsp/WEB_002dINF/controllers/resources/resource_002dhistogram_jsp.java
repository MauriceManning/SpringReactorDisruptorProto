...
public final class resource_002dhistogram_jsp extends org.apache.jasper.runtime.HttpJspBase
...
static {
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/controllers/resources/resource-histogram.jsp(10,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fsetTimeZone_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/controllers/resources/resource-histogram.jsp(11,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/controllers/resources/resource-histogram.jsp(14,0) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_c_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("\t<div id=\"responseTimeHistogram\" style=\"height: 200px;\"></div>\n");
        out.write("\t<script type=\"text/javascript\">\n");
        out.write("\t\tdojo.addOnLoad(function() {\n");
        out.write("\t\t\tdojo.require(\"insight.charting.ResponseTimeHistogram\");\n");
        out.write("\t\t\tvar timeRange = Insight.getTimeRange();\n");
        out.write("\t\t\tvar chart = new insight.charting.ResponseTimeHistogram({\n");
        out.write("\t\t\t\ttimeRange: timeRange,\n");
        out.write("\t\t\t\tdataPoints: 15,\n");
        out.write("\t\t\t\turl: Insight.buildUri(\"/services/resources/{resource}/{start}/{end}/histogram\", {\n");
        out.write("\t\t\t\t\tresource: '");
        ...
        out.write("\t\t\t\t})\n");
        out.write("\t\t\t}, \"responseTimeHistogram\");\n");
        out.write("\t\t\tchart.connect(chart, \"onChartElementClick\", function(event) {\n");
        out.write("\t\t\t\tif (event.element == \"bar\") {\n");
        out.write("\t\t\t\t\tvar s = this.stores.main, \n");
        out.write("\t\t\t\t\t\ti = s._items[event.index],\n");
        out.write("\t\t\t\t\t\tmin = s.getValue(i, \"start\"),\n");
        out.write("\t\t\t\t\t\tmax = s.getValue(i, \"end\"),\n");
        out.write("\t\t\t\t\t\ttimeRange = Insight.getTimeRange(),\n");
        out.write("\t\t\t\t\t\tstart = timeRange.getStart(),\n");
        out.write("\t\t\t\t\t\tend = timeRange.getEnd();\n");
        out.write("\t\t\t\t\tif (min == Number.NEGATIVE_INFINITY) { min = \"-infinity\" }\n");
        out.write("\t\t\t\t\tif (max == Number.POSITIVE_INFINITY) { max = \"infinity\" }\n");
        out.write("\t\t\t\t\tInsight.loadWindow(start, end, '");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${insight:escapeJs(resource.resource.key)}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, _jspx_fnmap_0, false));
        out.write("', min, max);\n");
        out.write("\t\t\t\t}\n");
        out.write("\t\t\t});\n");
        out.write("\t\t\tchart.subscribe(\"Insight.timeRangeMajorPulse\", function(timeRange) {\n");
